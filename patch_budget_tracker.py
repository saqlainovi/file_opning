...
# 1. Add state for expandedBudgetCode
...
old_table_body = """                    {(budgets.length > 0 ? budgets : INITIAL_BUDGET_DATA).map((item, index) => {
...
new_table_body = """                    {(budgets.length > 0 ? budgets : INITIAL_BUDGET_DATA).map((item, index) => {
